...
const ThreeNetworkScene = dynamic(() => import("@/components/ThreeNetworkScene"), {
  ssr: false,
  loading: () => <div className="h-full w-full bg-[linear-gradient(115deg,rgba(255,255,255,0.05),rgba(56,189,248,0.08),transparent)]" />,
});

export default function VisualSection() {
  return (
    <SectionWrapper className="overflow-hidden" eyebrow="Architecture technique" title="Des systèmes pensés pour durer et évoluer.">
